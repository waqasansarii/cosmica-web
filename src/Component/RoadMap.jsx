            ...
            <div className="road_map_main_div">
                ...
                <div className="road_map_stack">
                    <div className="rms_box1">
                        ...
                        <img className="rms1"  src={p1} alt="..." />
                        <img className="rms2" src={d1} alt="..." />
                    </div>
                    <div className="rms_box2">
                        <img className="rms3" src={p2} alt="..." />
